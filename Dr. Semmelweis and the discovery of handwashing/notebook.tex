...
{\color{incolor}In [{\color{incolor}210}]:} \PY{c+c1}{\PYZsh{} importing modules}
          ...
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{yearly}\PY{p}{)}
\end{Verbatim}
...
deaths at Clinic 1.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}212}]:} \PY{c+c1}{\PYZsh{} Calculate proportion of deaths per no. births}
          \PY{n}{yearly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{yearly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{/} \PY{n}{yearly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{births}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
          ...
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{yearly1}\PY{p}{)}
\end{Verbatim}
...
we'll see a curious pattern...
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}214}]:} \PY{c+c1}{\PYZsh{} This makes plots appear in the notebook}
          \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
          
          \PY{c+c1}{\PYZsh{} Plot yearly proportion of deaths at the two clinics}
          \PY{n}{ax} \PY{o}{=} \PY{n}{yearly1}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{year}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{clinic 1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Proportion Deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{yearly2}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{year}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{clinic 2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ax}\PY{o}{=}\PY{n}{ax}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}214}]:} <matplotlib.axes.\_subplots.AxesSubplot at 0x7f174ff52668>
\end{Verbatim}
...
any effect.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}216}]:} \PY{c+c1}{\PYZsh{} Read datasets/monthly\PYZus{}deaths.csv into monthly}
          ...
          \PY{n}{monthly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{monthly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{/} \PY{n}{monthly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{births}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
          
          \PY{c+c1}{\PYZsh{} Print out the first rows in monthly}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{monthly}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
you should be able to spot it!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}218}]:} \PY{c+c1}{\PYZsh{} Plot monthly proportion of deaths}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}218}]:} <matplotlib.text.Text at 0x7f174fcb3e10>
\end{Verbatim}
...
in the graph.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}220}]:} \PY{c+c1}{\PYZsh{} Date when handwashing was made mandatory}
          \PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k}{as} \PY{n+nn}{pd}
          ...
          \PY{n}{before\PYZus{}washing} \PY{o}{=} \PY{n}{monthly}\PY{p}{[}\PY{n}{monthly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{\PYZlt{}} \PY{n}{handwashing\PYZus{}start}\PY{p}{]}
          \PY{n}{after\PYZus{}washing} \PY{o}{=} \PY{n}{monthly}\PY{p}{[}\PY{n}{monthly}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{handwashing\PYZus{}start}\PY{p}{]}
          
          \PY{c+c1}{\PYZsh{} Plot monthly proportion of deaths before and after handwashing}
          \PY{n}{ax} \PY{o}{=} \PY{n}{before\PYZus{}washing}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{before hw}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Proportion deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{after\PYZus{}washing}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{after hw}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ax}\PY{o}{=}\PY{n}{ax}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}220}]:} <matplotlib.axes.\_subplots.AxesSubplot at 0x7f175618b2b0>
\end{Verbatim}
...
it reduce the monthly proportion of deaths on average?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}222}]:} \PY{c+c1}{\PYZsh{} Difference in mean monthly proportion of deaths due to handwashing}
          \PY{n}{before\PYZus{}proportion} \PY{o}{=} \PY{n}{before\PYZus{}washing}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
          \PY{n}{after\PYZus{}proportion} \PY{o}{=} \PY{n}{after\PYZus{}washing}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{proportion\PYZus{}deaths}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}222}]:} -0.08395660751183336
\end{Verbatim}
...
using the bootstrap method).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}224}]:} \PY{c+c1}{\PYZsh{} A bootstrap analysis of the reduction of deaths due to handwashing}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}224}]:} 0.025   -0.101567
          0.975   -0.066961
          dtype: float64
\end{Verbatim}
...
Viennese doctors to wash their hands.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} The data Semmelweis collected points to that:}
        \PY{n}{doctors\PYZus{}should\PYZus{}wash\PYZus{}their\PYZus{}hands} \PY{o}{=} \PY{k+kc}{True}
\end{Verbatim}
